    ...
    <div className="h-full flex flex-col p-5 sm:p-8 overflow-y-auto">
      <div className="flex items-center justify-between mb-6 sm:mb-8 gap-3">
        <div>
          ...
          <p className="text-xs sm:text-sm text-zinc-500 mt-1">Builders you're actively collaborating with.</p>
        </div>
        <div className="flex -space-x-3 shrink-0">
          ...
          <div className="w-8 h-8 rounded-full bg-zinc-100 border-2 border-white flex items-center justify-center text-xs font-medium text-zinc-500 z-0 relative">+1</div>
        </div>
      </div>
        ...
        {PEERS.map((peer, i) => (
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <button className="text-zinc-400 hover:text-blue-600 transition-colors opacity-100 sm:opacity-0 sm:group-hover:opacity-100">
