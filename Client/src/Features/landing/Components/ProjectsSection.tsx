...
export function ProjectsSection() {
  return (
    <section id="projects" className="py-20 sm:py-28 md:py-32 px-5 sm:px-6 max-w-7xl mx-auto border-t border-zinc-900">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 sm:mb-16">
        <div className="space-y-4">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-bold tracking-tight">Real projects built by matched teams.</h2>
        </div>
        <p className="text-zinc-400 max-w-sm text-sm">These aren't boilerplate templates — production-ready developer tools built over weekends and hackathons.</p>
      </div>
              ...
              <CardContent className="p-6 flex flex-col h-full justify-between space-y-6">
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                    ...
                    <ArrowUpRight className="w-5 h-5 text-zinc-500 group-hover:text-zinc-300 transition-colors shrink-0" />
                  </div>
